//! State + pure helpers for the "Add Remote Host" picker. A thin wrapper over
//! the shared `FilterPicker`: candidate hosts are the items, the input doubles
//! as live filter and free-text hostname, and `chosen_host` adds
//! selection-or-typed-text logic. Rendering lives in `ui/add_remote.rs`.
