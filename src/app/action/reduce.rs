...
pub fn apply_action(state: &mut AppState, action: Action) -> SideEffect {
    ...
    match action {
        ...
        Action::Menu(a) => return reduce_menu(state, a),
        ...
        Action::Pf(a) => return reduce_pf(state, a),
...
fn reduce_settings(state: &mut AppState, action: SettingsAction) -> SideEffect {
    let mut fx = SideEffect::default();
    match action {
        SettingsAction::Open => {
...
fn reduce_menu(state: &mut AppState, action: MenuAction) -> SideEffect {
    let mut fx = SideEffect::default();
    match action {
...
fn reduce_pf(state: &mut AppState, action: PfAction) -> SideEffect {
    let mut fx = SideEffect::default();
    match action {
        PfAction::Open(host) => {
            state.overlay.context_menu = None;
